...
{% imageFigure "/img/medium-1-UcGIqjyyJhu50EHxwgkGaQ.png", "Tokopedia product page showing an electric fan priced at IDR 52,050", "Tokopedia product page showing an electric fan priced at IDR 52,050." %}

If I were to select the cash / manual bank transfer method, I would see this screen:

{% imageFigure "/img/medium-1-wRwDv4z08GA5eMbpPoXrEQ.png", "My total, with the unique code (+032) added to the final bill.", "My total, with the unique code (+032) added to the final bill." %}
