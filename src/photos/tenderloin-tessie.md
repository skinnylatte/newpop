...
{% image "/img/9f601f2a5a.jpg", "a scan of a color photograph showing a sign on a tree that says Line This Way" %}

The line started on the street, on Geary and Franklin.

{% image "/img/e7aee000fa.jpg", "a scan of a color photograph showing a sign that says Free Haircuts" %}

There were also free haircuts to be had.

{% image "/img/b01a48b846.jpg", "a scan of a color photograph showing  a volunteer managing some tables with free clothing" %}

There was also free clothing, very neatly organized by gender and size.

{% image "/img/dac22fd7c8.jpg", "a scan of a color photograph showing some tables and chairs in an indoor church setting" %}

The venue was wonderful and light-filled.

{% image "/img/2843453d36.jpg", "a scan of a color photograph showing many gift bags on a table" %}
