...
{% image "/img/e17545d4f8.jpg", "a color photograph showing a large mosque with an ornate dome. in the background, some tall concrete buildings." %}
...
{% image "/img/0e9024e4d0.jpg", "a color photo showing a narrow alleyway between two historic short buildings leading towards a tall and modern hotel in the background" %}
...
{% image "/img/09df7ee438.jpg", "a black and white photo showing a contrast of architecture between old and new" %}
