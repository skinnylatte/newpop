...
{% image "/img/12baa863e9.jpg", "a scan of a black and white photo showing an outdoor garden dining space with space heaters" %}

The outdoor space at Blue Plate is quite lovely. So is the key lime pie there.

{% image "/img/122a2a3b79.jpg", "a scan of a black and white photo showing the neon symbols that are the sign of a bar in the Outer Mission" %}
...
{% image "/img/b5c01adeb7.jpg", "a scan of a black and white photo showing the retro sign of the Mission cinema" %}

Alamo Drafthouse in the Mission.

{% image "/img/a6c7fbfc1b.jpg", "a scan of a black and white photo showing a few people ordering tacos from a street taco vendor" %}
